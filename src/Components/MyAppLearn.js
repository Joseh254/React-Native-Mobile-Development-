...
export default function MyAppLearn() {
  ...
  console.log(useDeviceOrientation(), "dimenti");
  ...
  // console.log(Dimensions.get("window"));  window is the visible part of screen
  ...
  return (
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.container}>
        ...
        <Text>How is victory njeri?</Text>
